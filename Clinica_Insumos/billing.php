...
<div class="account" style="display: none;">
  ...
  <div class="content2">
    ...
    <?php echo $notice; ?>
    <div class="center">
      <span style="font-size: 16pt;color: #333333">Facturacion </span>
    </div>
  ...
  ?>
  <tr>
    <td colspan="2">Cuenta Total</td>
    <td colspan="2"><strong>$<?php echo $total ?></strong></td>
    <td><button class="btn btn-sm btn-primary btn-block" data-toggle="modal" data-target="#billOut">Ver Factura</button></td>
  </tr>
</table>
  </div>
</div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body"> <form method="POST" action="billout.php">
        <div style="width: 77%;margin: auto;">
          ...
          <div class="form-group">
            <label for="some" class="col-form-label">Nombre y Apellido</label>
            <input type="text" name="name" class="form-control" id="some" required>
          </div>
          <div class="form-group">
            <label for="some" class="col-form-label">Correo</label>
            <input type="text" name="contact" class="form-control" id="some" required>
          </div>
           <div class="form-group">
            <label for="some" class="col-form-label">Descuento</label>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" name="billInfo">Ver Factura</button>
      </div>
    </form>
    </div>
