  ...
  <div class="item">
      <ul class="nostyle zero">
       ...
       <a href="profile.php"><li><i class="fa fa-circle-o fa-fw"></i> Ajustes de Perfil</li></a>
        <a href="accountSetting.php"><li style="color: white"><i class="fa fa-circle-o fa-fw"></i> Ajustes de Cuenta</li></a>
...
<ol class="breadcrumb ">
    ...
    <div style="width: 55%;margin: auto;padding: 22px;" class="well well-sm center">
      ...
      <h4>Configuración de Inicio de Sesión</h4><hr>
      <form method="POST">
         <div class="form-group">
            <label for="some" class="col-form-label">Correo Electronico</label>
            <input type="email" name="email" class="form-control" value="<?php echo $user['email'] ?>" id="some" required>
          </div>
          <div class="form-group">
            <label for="some" class="col-form-label">Constraseña</label>
