  ...
  <div>
    ...
    <div class="item">
      <ul class="nostyle zero">
       ...
       <a href="addnew.php"><li style="color: white"><i class="fa fa-circle-o fa-fw"></i> Agregar Nuevo Producto</li></a>
  ...
  <div class="item">
      <ul class="nostyle zero">
       ...
       <a href="profile.php"><li><i class="fa fa-circle-o fa-fw"></i> Ajustes de Perfil</li></a>
        ...
        <a href="logout.php"><li><i class="fa fa-circle-o fa-fw"></i> Cerrar Sesion</li></a>
      </ul><
    </div>
</div>
...
if ($con->query("insert into inventeries (catId,supplier,name,unit,price,description,company) values ('$_POST[catId]','$_POST[supplier]','$_POST[name]','$_POST[unit]','$_POST[price]','$_POST[discription]','$_POST[company]')")) {
 ...
 ?>
  <div class="content2">
<ol class="breadcrumb ">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Panel</a></li>
        <li class="active">Agregar Nuevo Producto</li>
    </ol>
    <?php echo $notice ?>
    <div style="width: 55%;margin: auto;padding: 22px;" class="well well-sm center">

      <h4>Agregar Nuevo Producto</h4><hr>
      <form method="POST">
         <div class="form-group">
            <label for="some" class="col-form-label">Nombre</label>
            <input type="text" name="name" class="form-control" id="some" required>
          </div>
          <div class="form-group">
            <label for="some" class="col-form-label">Unidad</label>
            <input type="text" name="unit" placeholder="50mg" class="form-control" id="some" required>
          </div>
          <div class="form-group">
            <label for="some" class="col-form-label">Precio por Unidad</label>
            <input type="text" name="price" class="form-control" id="some" pattern="^\d+(\.\d+)?$" required>
          </div>
          <div class="form-group">
            <label for="some" class="col-form-label">Nombre del Provedor</label>
            <input type="text" name="supplier"  class="form-control" id="some" required>
          </div>
          <div class="form-group">
            <label for="some" class="col-form-label">Empresa de Medicamentos</label>
            <input type="text" name="company"  class="form-control" id="some" required>
          </div>
          <div class="form-group">
            <label for="some" class="col-form-label">Seleccionar Categoria</label>
           ...
           <div class="form-group">
            <label for="some" class="col-form-label">Descripcion</label>
