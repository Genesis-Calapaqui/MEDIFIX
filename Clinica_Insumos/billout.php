...
<body style="background: #ECF0F5;padding:0;margin:0">
  ...
  <div class="content2">
    ...
    <div class="well well-sm" style="width: 77%;margin: auto;">
      <table class="table table-bordered table-striped">
        ...
        <tr>
          <th>Factura generada el:</th>
          <td><?php echo date("Y-m-d h:i:sa"); ?></td>
          <th>Transacción realizada por:</th>
          <td><?php echo adminName(); ?></td>
        </tr>
        <tr>
          <th colspan="4" class="center"><h3>Detalles del Artículo de Compra</h3></th>
        </tr>
          <tr>
        <th>#</th>
        <th>Nombre del Medicamento/Insumo</th>
  ...
  ?>
  <tr>
    <td colspan="3" style="text-align: right;">Total Generado</td><th><?php echo $total; ?></th>
  </tr>
  <tr>
    <td colspan="3" style="text-align: right;">Descuento</td><th style="border-bottom: 1px solid blue;"><?php echo $_POST['discount']; ?></th>
  </tr>
  <tr>
    <td colspan="3" style="text-align: right;border-right: 1px solid blue">Total Generado</td><th style="border: 1px solid blue;"><?php echo $total-$_POST['discount']; ?></th>
  </tr>
  <tr>
    <td class="center" colspan="4"><button class="btn btn-primary" onclick="window.print()">Imprimir</button> <a href="index.php"><button class="btn btn-success">Regresar</button></a></td>
  </tr>
      </table>
    </div>
  </div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" name="safeIn">Ver factura</button>
      </div>
    </form>
    </div>
