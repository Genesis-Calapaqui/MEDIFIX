  ...
  <div>
    ...
    <div class="item">
      <ul class="nostyle zero">
        <a href="index.php" id="home-link"><li style="color: white"><i class="fa fa-circle-o fa-fw"></i> Home</li></a>
...
<div class="account" style="display: none;">
  ...
  <div style="padding: 11px;">
    ...
    <a href="http://localhost/medicamentos/Proyecto_html/home/"><button class="btn btn-default pull-right" style="border-radius: 0">Sign Out</button></a>
  </div>
</div>
  ...
  <div class="content2">
    ...
    <div>
      ...
      <button class="btn btn-primary btn-sm pull-right" data-toggle="modal" data-target="#addIn"><i class="fa fa-plus fa-fw"> </i>Agregar Nueva Categoria</button> 
