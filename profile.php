...
<div class="dashboard" style="position: fixed;width: 18%;height: 100%;background:#222D32">
  ...
  <div class="item">
      <ul class="nostyle zero">
       ...
       <a href="profile.php"><li style="color: white"><i class="fa fa-circle-o fa-fw"></i> Ajustes de Perfil</li></a>
    ...
    <div style="width: 55%;margin: auto;padding: 22px;" class="well well-sm center">
      ...
      <form method="POST">
         <div class="form-group">
          ...
          <div class="form-group">
            <label for="some" class="col-form-label">Codigo / Numero de Identificacion</label>
